...
📌 #include – This includes a library that allows us to use cout (to print messages). 
...
double price = 19.99; -Double variable "price" stores price as 19.99 
...
cout << "Price: <<price<<endl;−It prints price:"Enteredprice"
